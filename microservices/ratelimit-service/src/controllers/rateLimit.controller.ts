 ...
 */
export const checkRateLimit = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { apiKey, tokens = 1 } = req.body as {
      apiKey?: string;
      tokens?: number;
    };
 ...
 */
export const getRateLimitStatus = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const resetRateLimit = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const setCustomRateLimit = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    const { apiKey, limit, refillRate } = req.body as {
      apiKey?: string;
      limit?: number;
      refillRate?: number;
    };
